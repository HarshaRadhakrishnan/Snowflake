...
SELECT * FROM OUR_FIRST_DB.public.time_travel_clone before (statement => '01bfda06-0001-66d1-000c-61720002c2aa');

CREATE OR REPLACE TABLE OUR_FIRST_DB.PUBLIC.time_travel_clone_of_clone
CLONE OUR_FIRST_DB.public.time_travel_clone before (statement => '01bfda07-0001-66dd-000c-61720002d2a6');
